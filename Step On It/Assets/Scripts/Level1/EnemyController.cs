...
{
    public float jumpForce = 3200;                          // 弹跳力
    public bool canAirMove = true;                      // 在空中时，是否能移动
    ...
    const float m_NextGroundCheckLag = 0.0005f;    // 起跳后的一小段时间，不能再次起跳。防止连跳的一种解决方案
